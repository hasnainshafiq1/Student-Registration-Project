// var studentName = document.querySelectorAll(".studentName")[0];
// var fatherName = document.querySelectorAll(".fatherName")[0];
// var RollNo = document.querySelectorAll(".rollno")[0];
// var Weekend = document.querySelectorAll(".week")[0];
// var WeekDays = document.querySelectorAll(".weekend")[0];
// var Select = document.querySelectorAll(".select")[0];

// const obj = {name: studentName , fatherName: studentName, rollno:  RollNo};
